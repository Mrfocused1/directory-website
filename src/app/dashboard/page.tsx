                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-3 flex-wrap">
                    <a
                      ...
                      className="inline-flex items-center gap-2 h-11 px-6 bg-green-600 text-white rounded-full text-sm font-semibold hover:bg-green-700 transition shadow-md shadow-green-200"
                    >
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            {canBuildMore ? (
              ...
              <Link
                ...
                className="relative h-10 px-5 rounded-full text-sm font-semibold flex items-center gap-2 transition overflow-hidden bg-purple-50 text-purple-700 hover:bg-purple-100"
              >
