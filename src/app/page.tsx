...
const PRICING = [
  ...
  },
  {
    ...
    price: "Let's talk",
    period: "",
    tagline: "A directory built to spec.",
    features: [
      "Bespoke directory designed with you",
      "Unlimited posts across multiple sites",
      "Multi-creator / multi-platform accounts",
